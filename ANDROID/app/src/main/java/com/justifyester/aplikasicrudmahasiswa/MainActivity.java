...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://justifyapps.000webhostapp.com/retrieve.php";
    Employee employee;
    @Override
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://justifyapps.000webhostapp.com/delete.php",
                        ...
                        try{
                            ...
                            if(sucess.equals("1")){
                                ...
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    String ipk = object.getString("ipk");

                                    employee = new Employee(id,nama,nim,ipk);
